...
public class LurkingCow extends Cow implements Enemy, CanLookAt{

    private boolean staredAt;

    public LurkingCow(EntityType<? extends Cow> entityType, Level level) {
    ...
    public static AttributeSupplier.Builder createLurkingAttributes() {
        return Cow.createAttributes().add(Attributes.ATTACK_DAMAGE, 5).add(Attributes.MOVEMENT_SPEED, .5).add(Attributes.FOLLOW_RANGE, 60);
    }
