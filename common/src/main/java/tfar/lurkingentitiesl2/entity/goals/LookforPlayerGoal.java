...
import tfar.lurkingentitiesl2.entity.CanLookAt;
...
public class LookforPlayerGoal<T extends PathfinderMob & CanLookAt> extends NearestAttackableTargetGoal<Player> {
    ...
    public LookforPlayerGoal(T pathfinderMob, @Nullable Predicate<LivingEntity> pSelectionPredicate) {
        ...
        this.isAngerInducing = p_325811_ -> (pathfinderMob.isLookingAtMe((Player)p_325811_))
                && !pathfinderMob.hasIndirectPassenger(p_325811_);
        this.startAggroTargetConditions = TargetingConditions.forCombat().range(this.getFollowDistance()).selector(isAngerInducing);
    }
